...
PATH = './'
TRAIN = 'Protein_PNG/train'
TEST = 'Protein_PNG/test'
LABELS = 'Protein_PNG/train.csv'
SAMPLE = 'Protein_PNG/sample_submission.csv'
SPLIT = 'Protein_PNG/protein-trainval-split/'
...
md = get_data(sz,bs)
learner = ConvLearner.pretrained(resnet34, md, ps=0.5) #dropout 50%
...
learner.save_state_dict('ResNet34_256_1')
